  ...
  return (
    <div className="relative w-full h-[140px] sm:h-[180px] flex items-center justify-center select-none" aria-hidden="true">
      <svg viewBox="0 0 480 160" className="w-full max-w-[480px] h-full" fill="none">
        ...
        {/* Debate lines between agents - animated dashes */}
        <line x1="180" y1="40" x2="300" y2="80" stroke="#0F0F0F" strokeWidth="1.2" strokeDasharray="3 6" className="animate-[dash_2.5s_linear_infinite]" />
        <line x1="180" y1="80" x2="300" y2="40" stroke="#0F0F0F" strokeWidth="1.2" strokeDasharray="3 6" style={{ animationDelay: "0.4s" }} className="animate-[dash_2.5s_linear_infinite]" />
        <line x1="180" y1="80" x2="300" y2="120" stroke="#0F0F0F" strokeWidth="1.2" strokeDasharray="3 6" style={{ animationDelay: "0.8s" }} className="animate-[dash_2.5s_linear_infinite]" />
        <line x1="180" y1="120" x2="300" y2="80" stroke="#0F0F0F" strokeWidth="1.2" strokeDasharray="3 6" style={{ animationDelay: "1.2s" }} className="animate-[dash_2.5s_linear_infinite]" />
        <line x1="180" y1="40" x2="300" y2="120" stroke="#0F0F0F" strokeWidth="1.2" strokeDasharray="3 6" style={{ animationDelay: "1.6s" }} className="animate-[dash_2.5s_linear_infinite]" />
        <line x1="180" y1="120" x2="300" y2="40" stroke="#0F0F0F" strokeWidth="1.2" strokeDasharray="3 6" style={{ animationDelay: "2.0s" }} className="animate-[dash_2.5s_linear_infinite]" />
